package com.aperture.app.config;
...
@EnableMongoRepositories("com.aperture.app.repository")
...
public class DatabaseConfiguration {
    ...
    public Mongobee mongobee(Mongo mongo, MongoProperties mongoProperties) {
        ...
        mongobee.setChangeLogsScanPackage("com.aperture.app.config.dbmigrations");
